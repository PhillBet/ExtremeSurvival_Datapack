...
item replace entity @e[type=vindicator,tag=buffed] weapon.mainhand with diamond_axe{Enchantments: [{id: "mending", lvl: 1}, {id: "sharpness", lvl: 3}]}
...
item replace entity @e[type=zombified_piglin,tag=buffed] weapon.mainhand with diamond_sword{Enchantments: [{id: "sharpness", lvl: 5}, {id: "vanishing_curse", lvl: 1}]}
