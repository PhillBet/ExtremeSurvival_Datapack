...
replaceitem entity @e[type=husk,tag=!buffed] weapon.mainhand diamond_axe{Enchantments: [{id: "fire_aspect", lvl: 1}, {id: "vanishing_curse", lvl: 1}]}
...
replaceitem entity @e[type=wither_skeleton,tag=!buffed,name=!"EnderSkeleton"] weapon.mainhand bow{Enchantments: [{id: "power", lvl: 10}, {id: "flame", lvl: 1}]}
...
replaceitem entity @e[type=vindicator,tag=buffed] weapon.mainhand netherite_axe{Enchantments: [{id: "mending", lvl: 1}, {id: "sharpness", lvl: 5}]}
...
replaceitem entity @e[type=zombified_piglin,tag=buffed] weapon.mainhand netherite_sword{Enchantments: [{id: "sharpness", lvl: 5}, {id: "vanishing_curse", lvl: 1}]}
